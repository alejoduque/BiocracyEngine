...
#            Tres o cuatro es un buen número: cada uno se sostiene 9 segundos,
#            así que con seis la vuelta completa ya dura casi un minuto.
...
if [ "$KIND" = "hero" ]; then
    ...
    echo
    for a in "${added[@]}"; do
        echo "    'media/video/${a%%|*}.mp4',"
    done
    echo
    echo "Hydra crea cuatro fuentes (s0..s3), así que el ciclo admite"
    echo "un máximo de CUATRO clips. Con más, los de sobra se ignoran."
else
